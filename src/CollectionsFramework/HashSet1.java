...
public class HashSet1 {
	...
	public static void main(String[] args) {
		...
		//intersect.zapazi vsi4ki koeto sa v intersekta(javaStidents) i PHPstudents
		...
		//premahni vsi4ki obshti! ot javaStrudents premahni vsiki koito gi ima i v PHPStudents
